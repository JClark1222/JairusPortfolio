...
connection = create_server_connection("localhost","Jairus",'!Rahway9567','')
...
connection = create_server_connection("localhost","Jairus",'!Rahway9567', 'school')
...
connection = create_server_connection("localhost", "root", '!Rahway9567', 'school')
...
delete_course = """
DELETE FROM course 
WHERE course_name = Intermediate English;
"""
